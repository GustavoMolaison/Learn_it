...
class csb(): 
      ...
      #       def back_button():
      #         self.frame_learn_button.destroy()
      ...
      #       self.back_button = tk.Button(self.frame_learn_button, text = '<---', bg = 'black', fg='yellow', width=10, height=2, command = lambda: back_button() )
      ...
      #       self.latly_used_frame.place(x = 1390, y = 250)
        ...
        if __name__ == '__main__':
             from inter_face import Learn_button_com 
