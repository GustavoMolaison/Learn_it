...
def registration():
    ...
    if not len(username_text) >= 3:
        ...
        try:
            ...
            pass
        reg_error_input = Label(text='Sadly this username is occupied by another user', fg='white', bg='black',
                                height=2,
            ...
            if big_letter_count >= 1:
                ...
                if m:
                    ...
                    try:
                        ...
                        pass
                    reg_error_input = Label(text='password must contain at least 1 special character', fg='white',
                                            bg='black',
...
def login_screen():
    global screen, password, username, login_button, reg_button0, pass_entry, user_entry
    screen = Tk()
    ...
    reg_button0 = Button(screen, text='registration', width=20, bg='black', fg='yellow', command=register)
    login_button.place(x=465, y=320)
    reg_button0.place(x=465, y=360)
    screen.mainloop()
